/* ---------------------------------------------------------------------
  ...
  function isCheck() {
    ...
    if (radiobtn.checked) {
      radiobtnone.classList.remove('text-danger-500');
      radiobtnone.classList.add('text-success-500');
      radiobtntwo.classList.remove('text-danger-500');
      radiobtntwo.classList.add('text-success-500');
      document.getElementById('supportedradiobtnhide').classList.add('hidden');
    } else {
      radiobtnone.classList.add('text-success-500');
      // radiobtnone.classList.add('text-danger-500');
      radiobtntwo.classList.add('text-success-500');
      // radiobtntwo.classList.add('text-danger-500');
      document.getElementById('supportedradiobtnhide').classList.add('hidden');
    }
  }

...
<!-- Mirrored from templates.iqonic.design/product/qompac-ui-tailwind/tailwind/dist/dashboard/blank-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Dec 2023 10:13:30 GMT -->

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title data-setting="app_name" x-text="setting.app_name + ' | Responsive Tailwind Admin Dashboard Template'">Qompac UI
        | Responsive Tailwind Admin Dashboard Template</title>
    ...
    <main class="main-content " x-data="{ data: true }">
        <div class="relative">
            ...
            <nav class="z-40 bg-white dark:bg-dark-card nav shadow-lg navbar navbar-expand-xl navbar-light iq-navbar py-0"
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute flex items-center px-2 py-1 text-xl border border-secondary-500 rounded lg:hidden"
                            ...
                            <button type="button" @click="selected == 1 ? selected = null : selected = 1"
                                ...
                                <svg class="block w-8 h-8" id="mobileicon" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="flex">
                            <div class="flex items-center xl:hidden gap-2 display-none">
                                ...
                                <a href="index.html" class="flex items-center whitespace-nowrap gap-4">
                                    ...
                                    <svg width="30" class="text-primary-500 dark:text-primary-500 brand-logo"
                                    ...
                                    <!--logo End-->
                                    <h4 class="mb-0" data-setting="app_name" x-text="setting.app_name"> Qompac
                                        UI </h4>
                                </a href="#">
                            </div>
                            <div class="breadcrumb-title xl:flex sm:hidden justify-center items-center lg:flex ml-2">
                                <small
                                    class="capitalize hidden md:block mr-3 pr-3 border-r border-secondary-300 dark:border-secondary-700 dark:text-white">blank-page</small>
                            </div>
                            <div class="offcanvas-body">
                                <ul
                                    class="iq-nav-menu header-menu w-full lg:w-auto list-unstyled ml-2 rtl:mr-2 rtl:ml-0">
                                    <li class="nav-item active">
                                        <a class=" menu-arrow justify-start text-secondary-600"
                                            href="javascript:void(0)" aria-controls="homeData">
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled" id="homeData">
                                            ...
                                            <li class="nav-item"><a class="nav-link " href="crypto.html">Crypto</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#menuStyles"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-arrow justify-start text-secondary-600"
                                            href="javascript:void(0)" aria-controls="allPagesData">
                                            <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled" id="allPagesData">
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow " href="#specialPages"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#authSkins"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#userApps"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#utilities"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#extraPlugins"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-arrow justify-start text-secondary-600"
                                            href="javascript:void(0)" aria-controls="elementsData">
                                            <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled" id="elementsData">
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#widgetsPage"
                                                ...
                                                <ul class="iq-header-sub-menu left list-unstyled" id="widgetsPage">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/alerts.html">Alert</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/badges.html">Badges</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/offcanvas.html">Offcanvas</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/notification.html">Notification</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/list-group.html">List group</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/card.html">Card</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/video.html">Video</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/buttons-group.html">Button Group</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/breadcrumb.html">Breadcrumb</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/buttons.html">Buttons</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/pagination.html">Pagination</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/popovers.html">Popovers</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/tabpans.html">Tabpans</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="ui-elements/tooltips.html">Tooltips</a></li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#widgetsPage"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#mapPages"
                                                ...
                                                <ul class="iq-header-sub-menu left list-unstyled" id="mapPages">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="map/google.html">Google</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="map/vector.html">Vector</a></li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#formsPages"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#tablesPages"
                                                ...
                                                <ul class="iq-header-sub-menu left list-unstyled" id="tablesPages">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="table/data-table.html">Tailwind Table</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="table/bordered-table.html">Data Table</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="table/fancy-table.html">Fancy Table</a></li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link menu-arrow" href="#iconsPages"
                                                ...
                                                <ul class="iq-header-sub-menu left list-unstyled" id="iconsPages">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="icon/solid.html">Solid</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="icon/outlined.html">Outlined</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="icon/dual-tone.html">Dual Tone</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <div class="hidden lg:flex lg:flex-grow transition-all duration-700 ease-in-out">
                                <ul class="flex items-center mb-2 ml-auto rtl:ml-0 rtl:mr-auto lg:mb-0">
                                    <li class="flex items-center pl-2" x-data="{ open: false }">
                                        <a href="#"
                                            class="block p-2 hover:text-primary-500 focusa text-secondary-600"
                                            @click="open = !open" id="mode-drop">
                                            <svg class="icon-24 color-secondary" width="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <div x-show="open" class="absolute z-40 drop-shadow-lg  top-14 w-40 "
                                            ...
                                            <div
                                                class="bg-white dark:bg-dark-bg shadow-lg p-2 rounded dark:text-white">
                                                <a href="#"
                                                    ...
                                                    <input type="radio" value="light" class="hidden"
                                                        name="theme_scheme" id="light-theme"
                                                        x-model="setting.theme_scheme">
                                                ...
                                                <a href="#"
                                                    class="flex justify-between w-full  py-1 hover:bg-primary-500/[0.1] hover:text-primary-500 hover:rounded hover:ease-in-out duration-300 dark:text-white dark:hover-text-primary-500 group">
                                                    <input type="radio" value="dark" class="hidden"
                                                        name="theme_scheme" id="dark-theme"
                                                        x-model="setting.theme_scheme">
                                                ...
                                                <a href="#"
                                                    class="flex justify-between w-full  py-1  hover:bg-primary-500/[0.1] hover:text-primary-500 hover:rounded hover:ease-in-out duration-300 dark:text-white dark:hover-text-primary-500 group">
                                                    <input type="radio" value="auto" class="hidden"
                                                        name="theme_scheme" id="auto-theme"
                                                        x-model="setting.theme_scheme">
                                    ...
                                    <li class="nav-item iq-full-screen sm:hidden xl:block border-r"
                                        id="fullscreen-item">
                                        <a class="flex items-center p-2 hover:text-primary-500 focusa text-secondary-600"
                                            x-data="fullscreen" href="#" @click="toggle">
                                            <div class="w-8 rounded-full">
                                                <span class="btn-inner">
                                                    <svg class="normal-screen icon-32"
                                                        :class="fullscreen ? 'hidden' : ''" width="32"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M18.5528 5.99656L13.8595 10.8961"
                                                    ...
                                                    <svg class="full-normal-screen icon-24"
                                                        :class="!fullscreen ? 'hidden' : ''" width="32"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li x-data="{ open: false }" id="itemdropdown1">
                                        <a class="py-0 flex items-center p-2 ml-2 hover:text-primary-500 active:text-primary-500 focus:text-primary-500 focus"
                                            href="#" id="profile-setting" @click="open = !open"
                                            aria-expanded="false">
                                            ...
                                            <div class="caption ml-3 d-none d-md-block ">
                                                ...
                                                <p
                                                    class="mb-0 caption-sub-title focusa active:text-primary-500  focus:text-primary-500 hover:text-primary-500 text-black mr-4">
                ...
                <div id="headsm"
                    class="md:mt-0 overflow-hidden  lg:hidden flex w-full bg-white top-12 px-7 transition-all duration-700 max-h-0 pb-2 dark:bg-dark-card"
                    style="" x-ref="container1"
                    x-bind:style="selected == 1 ? 'max-height:' + $refs.container1.scrollHeight + 'px' : ''">
                    <ul class="flex items-center mb-4 mt-5 ml-auto rtl:ml-0 rtl:mr-auto lg:mb-0">
                        <li class="flex items-center pl-2" x-data="{ open: false }">
                            <a href="#" class="block p-2 group hover:text-primary-500 text-secondary-600"
                                @click="open = !open">
                            ...
                            <div x-show="open" class=" rounded drops shadow w-80" @click.outside="open = false"
                                ...
                                <div class="bg-white dark:bg-dark-card shadow-lg  dark:text-secondary-600 ">
                                    <div class="flex px-5 py-3  rounded-t">
                                        <a href="#" class="nav-link show" id="search-drop"
                                            data-bs-toggle="dropdown" aria-expanded="true">
                                            <input type="text"
                                                class="text-black  search-input form-control bg-primary-100/[0.1]"
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    ...
                                                    <small
                                                        class="LR text-lg text-secondary-500 dark:text-secondary-600">paige001</small>
                                                </div>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    ...
                                                    <small
                                                        class="text-lg text-secondary-500 dark:text-secondary-600">Carlo.m</small>
                                                </div>
                                            </div>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    ...
                                                    <small
                                                        class="text-lg text-secondary-500 dark:text-secondary-600">Paul45</small>
                                                </div>
                                            </div>
                        ...
                        <li class="flex items-center pl-2" x-data="{ open: false }">
                            <a href="#" class="block p-2 hover:text-primary-500 text-secondary-600"
                                @click="open = !open" id="mode-drop">
                            ...
                            <div x-show="open" class="drop-shadow-lg rounded drops w-40 "
                                ...
                                x-transition:leave-start="opacity-100 transform translate-y-0"
                                x-transition:leave-end="opacity-0 transform translate-y-0">
                                <div class="bg-white dark:bg-dark-card shadow-lg rounded p-2 dark:text-secondary-600 ">
                                    <a href="#"
                                        class="flex justify-between w-full py-1 hover:bg-primary-500/[0.1] hover:text-primary-500 hover:rounded hover:ease-in-out duration-300 group">
                                        <input type="radio" value="ltr" class="hidden"
                                            name="theme_scheme_direction" id="ltr"
                                            x-model="setting.theme_scheme_direction">
                                        <label class="flex items-center" for="ltr">
                                            <div>
                                            ...
                                            <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                <h6 class="mb-0 text-secondary-500 font-medium">LTR</h6>
                                            </div>
                                        </label>
                                    </a>
                                    <a href="#"
                                        class="flex justify-between w-full py-1 hover:bg-primary-500/[0.1] hover:text-primary-500 hover:rounded hover:ease-in-out duration-300 group">
                                        <input type="radio" value="rtl" class="hidden"
                                            name="theme_scheme_direction" id="rtl"
                                            x-model="setting.theme_scheme_direction">
                                        <label class="flex items-center" for="rtl">
                                            <div>
                                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                <h6 class="mb-0 text-secondary-500 font-medium">RTL</h6>
                                            </div>
                                        </label>
                                    </a>
                                </div>
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    ...
                                                    <small
                                                        class="LR text-sm text-secondary-500 dark:text-secondary-600">95
                                                        MB</small>
                                                </div>

                                            </div>
                                            <div class="flex items-end"><small
                                                    class="RL text-sm text-secondary-500 dark:text-secondary-600 ">Just
                                                    Now</small></div>
                                        </a>
                                        <a href="#"
                                            class="flex justify-between w-full px-5 py-3 border-b dark:border-secondary-700 hover:bg-primary-500/[0.1] group">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3 rtl:ml-0 rtl:mr-3 LR">
                                                    ...
                                                    <small
                                                        class="text-sm text-secondary-500 dark:text-secondary-600">Cyst
                                                        Bni</small>
                                                </div>
                                            </div>
                                            <div class="flex items-end"><small
                                                    class="RL text-sm text-secondary-500 dark:text-secondary-600 ">5
                                                    days ago</small></div>
                                        </a>
                                        <a href="#"
                                            class="flex justify-between w-full px-5 py-3 border-b dark:border-secondary-700 hover:bg-primary-500/[0.1] group">
                                            ...
                                            <div class="flex items-end"><small
                                                    class="RL text-sm text-secondary-500 dark:text-secondary-600 ">2
                                                    days ago</small></div>
                                        </a>
                                        <a href="#"
                                            class="flex justify-between w-full px-5 py-3 border-b dark:border-secondary-700 hover:bg-primary-500/[0.1] group">
                                            ...
                                            <div class="flex items-end"><small
                                                    class="RL text-sm text-secondary-500 dark:text-secondary-600 ">3
                                                    days ago</small></div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <li class="flex items-center pl-2" x-data="{ open: false }">
                            <a href="#" class="block p-2 hover:text-primary-500 text-secondary-600"
                                @mouseover="open = !open" id="mode-drop">
                                <svg class="icon-24 color-secondary" width="24" viewBox="0 0 24 24"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M11.9905 5.62598C10.7293 5.62574 9.49646 5.9995 8.44775 6.69997C7.39903 7.40045 6.58159 8.39619 6.09881 9.56126C5.61603 10.7263 5.48958 12.0084 5.73547 13.2453C5.98135 14.4823 6.58852 15.6185 7.48019 16.5104C8.37186 17.4022 9.50798 18.0096 10.7449 18.2557C11.9818 18.5019 13.2639 18.3757 14.429 17.8931C15.5942 17.4106 16.5901 16.5933 17.2908 15.5448C17.9915 14.4962 18.3655 13.2634 18.3655 12.0023C18.3637 10.3119 17.6916 8.69129 16.4964 7.49593C15.3013 6.30056 13.6808 5.62806 11.9905 5.62598Z"
                        ...
                        <li x-data="{ open: false }" id="itemdropdown1">
                            <a class="py-0 flex items-center p-1 hover:text-primary-500" href="#"
                                id="profile-setting" @click="open = !open" aria-expanded="false">
                                <img src="../assets/images/avatars/01.png" alt="User-Profile"
                                    class="h-12 w-12 rounded-full truncate" loading="lazy">
        ...
        <div class="p-6 lg:p-8 footer-inner  mx-auto main-container  lg:py-0 py-0 "

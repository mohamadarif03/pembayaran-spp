...
x-bind:class="[setting.sidebar_menu_style, setting.sidebar_color, setting.sidebar_type.join(' ')]"
class="z-50 sidebar shadow-lg sidebar-base sidebar-default " data-toggle="main-sidebar" @resize.window="resize"
id="first-tour">
<div class="sidebar-header relative flex items-center justify-start mb-3 border-b dark:border-gray-700 z-0">
    <a href="index.html" class="flex px-5 py-4 mr-4 rtl:ml-4 rtl:mr-0 text-xl whitespace-nowrap">
        <!--Logo start-->

        <svg width="30" class="text-primary-500 dark:text-primary-500 brand-logo" viewBox="0 0 30 30"
...
<div class="sidebar-body data-scrollbar">
    <ul class="sidebar-main-menu">
        ...
        <li class="nav-item ">
            <a class="nav-link " aria-current="page" href="analytics.html">
        ...
        <li class="nav-item ">
            <a class="nav-link " aria-current="page" href="crypto.html">
                <i class="icon" data-tp-toggle="tooltip" data-tp-placement="left" data-tp-title="Crypto">
        ...
        <li class="nav-item" :class="selected.includes('menu_style') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('menu_style') ? 'active' : ''"
                @click="toggle('menu_style')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-placement="left"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white dark:text-white"
            ...
            <ul class="sub-menu" id="horizontal-menu" x-ref="menu_style"
                ...
                <li class="nav-item">
                    <a class=" nav-link  " href="index-dual-compact.html">
                        <i class="icon svg-icon text-secondary-600">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                fill="currentColor">
                                <g>
                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-placement="left"
                            data-tp-title="Dual Compact"> D </i>
                ...
                <li class="nav-item">
                    <a class=" nav-link " href="index-boxed.html">
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-placement="left"
                            data-tp-title="Boxed Horizontal"> B </i>
        ...
        <li class="nav-item" :class="selected.includes('spacial_pages') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('spacial_pages') ? 'active' : ''"
                @click="toggle('spacial_pages')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-placement="left"
                    data-tp-title="Special Pages">
                    <svg width="20" class="icon-20" viewBox="0 0 14 13" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white dark:text-white"
                    x-bind:style="selected.includes('spacial_pages') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="spacial_pages-menu" x-ref="spacial_pages"
                x-bind:style="selected.includes('spacial_pages') ? 'max-height: ' + $refs.spacial_pages.scrollHeight + 'px' :
                    ''">
                <li class="nav-item">
                    <a class="nav-link " href="special-pages/billing.html"
                        data-sidebar-parent="spacial_pages">
                        <i class="icon">
        ...
        <li class="nav-item" :class="selected.includes('auth') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('auth') ? 'active' : ''" @click="toggle('auth')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-placement="left"
                    data-tp-title="Auth Skins">
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('auth') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="auth-menu" x-ref="auth"
                x-bind:style="selected.includes('auth') ? 'max-height: ' + '100%' : ''">
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="auth/confirm-mail.html">
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-placement="left"
                            data-tp-title="Confirm Mail">CM</i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="auth/lock-screen.html">
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-placement="left"
                            data-tp-title="Lock Screen">LS</i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="auth/recoverpw.html">
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-placement="left"
                            data-tp-title="Recover password"> RP </i>
                        <span class="item-name ">Recover password</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="auth/two-factors.html">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="auth/deactivate.html">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
        ...
        <li class="nav-item" :class="selected.includes('users') ? 'active' : ''">
            ...
            <ul class="sub-menu" id="users-menu" x-ref="users"
                ...
                <li class="nav-item">
                    <a class="nav-link " href="app/user-profile.html" data-sidebar-parent="users">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="app/user-add.html" data-sidebar-parent="users">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="app/user-list.html" data-sidebar-parent="users">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
        ...
        <li class="nav-item" :class="selected.includes('utilites') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('utilites') ? 'active' : ''"
                @click="toggle('utilites')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Utilites"
                ...
                <span class="item-name ">Utilites</span>
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('utilites') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="utilites-menu" x-ref="utilites"
                x-bind:style="selected.includes('utilites') ? 'max-height: ' + $refs.utilites.scrollHeight + 'px' : ''">
                <li class="nav-item">
                    <a class="nav-link" href="errors/error404.html">
                        <i class="icon" data-tp-toggle="tooltip" data-tp-title="Error 404"
                            data-tp-placement="left">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="errors/error500.html">
                        <i class="icon" data-tp-toggle="tooltip" data-tp-title="Error 500"
                            data-tp-placement="left">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="errors/maintenance.html">
                        <i class="icon" data-tp-toggle="tooltip" data-tp-title="Maintenance"
                            data-tp-placement="left">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
        ...
        <li class="nav-item" :class="selected.includes('plugins') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('plugins') ? 'active' : ''"
                @click="toggle('plugins')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Plugins" data-tp-placement="left">
                    <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('plugins') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="plugins-menu" x-ref="plugins"
                x-bind:style="selected.includes('plugins') ? 'max-height: ' + $refs.plugins.scrollHeight + 'px' : ''">
                <li class="nav-item">
                    <a class="nav-link " href="plugins/apexcharts.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Apexcharts"
                            data-tp-placement="left"> A </i>
                        <span class="item-name ">Apexcharts</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/button-hover.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Button Hover"
                            data-tp-placement="left"> BH </i>
                        <span class="item-name ">Button Hover </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/choise-js.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Choice JS"
                            data-tp-placement="left"> C </i>
                        <span class="item-name ">Choice JS</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/flatpickr.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Flatpickr"
                            data-tp-placement="left"> F </i>
                        <span class="item-name ">Flatpickr </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/fslightbox.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="FSlightbox"
                            data-tp-placement="left"> F </i>
                        <span class="item-name ">FSlightbox </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/gallery-hover.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Gallery Hover"
                            data-tp-placement="left"> G </i>
                        <span class="item-name ">Gallery Hover </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/loader.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Loader"
                            data-tp-placement="left"> L </i>
                        <span class="item-name ">Loader </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/sweet-alert.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Sweet Alert"
                            data-tp-placement="left"> S </i>
                        <span class="item-name ">Sweet Alert</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/quill-editor.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="quill-editor"
                            data-tp-placement="left"> T </i>
                        <span class="item-name ">Quill</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="plugins/uppy.html" data-sidebar-parent="plugins">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Uppy"
                            data-tp-placement="left">
                            U </i>
        ...
        <li class="nav-item">
            <a class="nav-link active" href="blank-page.html">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Blank Page"
                    data-tp-placement="left">
        ...
        <li class="nav-item" :class="selected.includes('elements') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('elements') ? 'active' : ''"
                @click="toggle('elements')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="elements"
                    data-tp-placement="left">
                    <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('elements') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="elements-menu" x-ref="elements"
                x-bind:style="selected.includes('elements') ? 'max-height: ' + $refs.elements.scrollHeight + 'px' : ''">
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/avatars.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Widget Chart"
                            data-tp-placement="right"> WC
                        </i>
                        <span class="item-name ">Avatars</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/alerts.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Widget Basic"
                            data-tp-placement="right"> WB </i>
                        <span class="item-name ">Alerts</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/badges.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Widget Chart"
                            data-tp-placement="right"> WC </i>
                        <span class="item-name ">Badges</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/breadcrumb.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/buttons.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Widget Card"
                            data-tp-placement="right"> WC
                        </i>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/buttons-group.html"
                        data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <span class="item-name ">Button Group</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/offcanvas.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/colors.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/card.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <span class="item-name ">Card</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/carousel.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/grid.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/images.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/list-group.html"
                        data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/modal.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/notification.html"
                        data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/pagination.html"
                        data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/popovers.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/tabpans.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/tooltips.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="ui-elements/video.html" data-sidebar-parent="elements">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
        ...
        <li class="nav-item" :class="selected.includes('widgets') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('widgets') ? 'active' : ''"
                @click="toggle('widgets')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Widgets"
                    data-tp-placement="left">
                    <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('widgets') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="widgets-menu" x-ref="widgets"
                x-bind:style="selected.includes('widgets') ? 'max-height: ' + $refs.widgets.scrollHeight + 'px' : ''">
                <li class="nav-item">
                    <a class="nav-link " href="widget/widgetbasic.html" data-sidebar-parent="widgets">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="widget/widgetchart.html" data-sidebar-parent="widgets">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="widget/widgetcard.html" data-sidebar-parent="widgets">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
        ...
        <li class="nav-item" :class="selected.includes('maps') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('maps') ? 'active' : ''" @click="toggle('maps')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Maps"
                    data-tp-placement="left">
                    <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('maps') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="maps-menu" x-ref="maps"
                x-bind:style="selected.includes('maps') ? 'max-height: ' + $refs.maps.scrollHeight + 'px' : ''">
                <li class="nav-item">
                    <a class="nav-link " href="map/google.html" data-sidebar-parent="maps">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Google"
                            data-tp-placement="left"> G </i>
                        <span class="item-name ">Google</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="map/vector.html" data-sidebar-parent="maps">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Vector"
                            data-tp-placement="left"> V </i>
        ...
        <li class="nav-item" :class="selected.includes('form') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('form') ? 'active' : ''" @click="toggle('form')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Form"
                    data-tp-placement="left">
                    <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('form') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="form-menu" x-ref="form"
                x-bind:style="selected.includes('form') ? 'max-height: ' + $refs.form.scrollHeight + 'px' : ''">
                <li class="nav-item">
                    <a class="nav-link " href="form/form-element.html" data-sidebar-parent="form">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Elements"
                            data-tp-placement="left"> E </i>
                        <span class="item-name ">Elements</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="form/form-wizard.html" data-sidebar-parent="form">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Wizard"
                            data-tp-placement="left"> W </i>
                        <span class="item-name ">Wizard</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="form/form-validation.html" data-sidebar-parent="form">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Validation"
                            data-tp-placement="left"> V </i>
        ...
        <li class="nav-item" :class="selected.includes('table') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('table') ? 'active' : ''"
                @click="toggle('table')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Table"
                    data-tp-placement="left">
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('table') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="table-menu" x-ref="table"
                x-bind:style="selected.includes('table') ? 'max-height: ' + $refs.table.scrollHeight + 'px' : ''">

                <li class="nav-item">
                    <a class="nav-link " href="table/tailwind-table.html" data-sidebar-parent="table">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Datatable"
                            data-tp-placement="left"> D </i>
                        <span class="item-name ">Tailwind Table</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="table/data-table.html" data-sidebar-parent="table">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                ...
                <li class="nav-item">
                    <a class="nav-link " href="table/bordered-table.html" data-sidebar-parent="table">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip"
                            data-tp-title="Bordered Table" data-tp-placement="left"> BT </i>
                        <span class="item-name ">Bordered Table</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="table/fancy-table.html" data-sidebar-parent="table">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Fancy Table"
                            data-tp-placement="left"> F </i>
        ...
        <li class="nav-item" :class="selected.includes('icons') ? 'active' : ''">
            <a class="nav-link" :class="selected.includes('icons') ? 'active' : ''"
                @click="toggle('icons')">
                <i class="icon" data-tp-toggle="tooltip" data-tp-title="Icons"
                    data-tp-placement="left">
                    <svg class="icon-20" xmlns="http://www.w3.org/2000/svg" width="20"
                ...
                <i class="rtl:rotate-180 right-icon dark:text-white"
                    x-bind:style="selected.includes('icons') ? 'transform:  rotate(90deg)' : ''">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5l7 7-7 7"></path>
            ...
            <ul class="sub-menu" id="icons-menu" x-ref="icons"
                x-bind:style="selected.includes('icons') ? 'max-height: ' + $refs.icons.scrollHeight + 'px' : ''">
                <li class="nav-item">
                    <a class="nav-link " href="icon/solid.html" data-sidebar-parent="icons">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Solid"
                            data-tp-placement="left"> S </i>
                        <span class="item-name ">Solid</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="icon/outlined.html" data-sidebar-parent="icons">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Outlined"
                            data-tp-placement="left"> O </i>
                        <span class="item-name ">Outlined</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="icon/dual-tone.html" data-sidebar-parent="icons">
                        <i class="icon">
                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <g>
                        ...
                        <i class="sidenav-mini-icon" data-tp-toggle="tooltip" data-tp-title="Dual Tone"
                            data-tp-placement="left"> D </i>

                                                ...
                                                <div class="flex-auto p-4 text-secondary-600">
                                                    <div class="mb-4">
                                                        <label
                                                            ...
                                                            kelas: </label>
                                                        <input type="text"
                                                            class="w-full px-4 py-2 border dark:bg-dark-card dark:border-secondary-800 rounded outline-none focus:border-primary-500 focus:shadow dark:focus:border-primary-500">
                                                    </div>
                                                </div>
                                                <div
